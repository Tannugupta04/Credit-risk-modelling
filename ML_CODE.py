...
# Load the dataset
a1 = pd.read_excel(r"C:\Users\gupta\Downloads\case_study1.xlsx")
a2 = pd.read_excel(r"C:\Users\gupta\Downloads\case_study2.xlsx")
...
# UNSEEN DATA PREDICTION PIPELINE


# -------------------------------
# 1. Load unseen dataset
# -------------------------------
a3 = pd.read_excel(r"C:\Users\gupta\Downloads\Unseen_Dataset.xlsx")
...
a3.to_excel(r"C:\Users\gupta\Downloads\Final_Predictions.xlsx")
...
os.makedirs(r"C:\Projects\credit_risk\model", exist_ok=True)

with open(r"C:\Projects\credit_risk\model\xgb_model.pkl", "wb") as f:
    pickle.dump(model, f)
